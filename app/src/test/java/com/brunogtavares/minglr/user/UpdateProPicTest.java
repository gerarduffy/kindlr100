...
public class UpdateProPicTest {
    ...
    public void testMethod(){
        ...
        String changeProfilePic = "http://newurl.com/";
        testUser1.setUserProfileImage(changeProfilePic);

        assertEquals(changeProfilePic , testUser1.getUserProfileImage());
    }
