...
public class ChangeBioTest {
    ...
    public void testMethod(){
        ...
        String changeBio = "This is the new bio that we would like to test. It should be returned by the test method.";

        testUser1.setUserDescription(changeBio);

        assertEquals(changeBio , testUser1.getUserDescription());
    }
